package test;
/*
    Recomendacion para probar cada ejercicio 
    quitar los comentarios de dicho ejercicio
    @author VirusJac 
    @version 1
...
//        ---Prueba ejercicio 4 clase 6 ---
//        String totalCuenta = JOptionPane.showInputDialog(null, "Ingrese el total de la cuenta", "Entrada", JOptionPane.QUESTION_MESSAGE);
//        String porcentajePropina = JOptionPane.showInputDialog(null, "Ingrese el porcentaje de propina que desea dejar(sin el signo %)", "Entrada", JOptionPane.QUESTION_MESSAGE);
//        CalculadoraPropinas propinaTest = new CalculadoraPropinas(Integer.parseInt(totalCuenta), Integer.parseInt(porcentajePropina));
//        JOptionPane.showMessageDialog(null,"El monto seria de " + propinaTest.getMontoPropina()+ " Bs.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        


//        ---Prueba ejercicio 5 clase 5 ---        
//        adivinaNumero testNumero = new adivinaNumero();
//        String entrada;
//        int numero;
//        String mensaje;
//        do {
//            entrada = JOptionPane.showInputDialog(null, "Introduce un numero entre 1-100", "Entrada", JOptionPane.QUESTION_MESSAGE);
//            numero = Integer.parseInt(entrada);
//            mensaje = testNumero.adivinarNumero(numero);
//            JOptionPane.showMessageDialog(null, mensaje, "Mensaje", JOptionPane.INFORMATION_MESSAGE);
//        } while (numero != 0 && !mensaje.startsWith("¡Has adivinado"));
   }
}
